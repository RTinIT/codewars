...
// of all listeners. Names should be treated in a case-insensitive manner, i.e.
...
class Song {
  ...
  howMany (listeners) {
    ...
    const nonCaseListeners = listeners.map(e => e = e.toLowerCase());

    nonCaseListeners.forEach(e => {
